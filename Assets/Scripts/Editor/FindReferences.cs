...
//  To use, stick this under a folder named "Editor", then right click an object/script in the
//  project window and click "Find References" Made by Dave Lloyd- www.powerhoof.com - but go nuts
...
public class FindReferences : EditorWindow
{
  ...
  [MenuItem ("Dicecraft/Find References")]
  static void FindObjectReferences()
  {
    //Show existing window instance. If one doesn't exist, make one.
    var window = EditorWindow.GetWindow<FindReferences>(true, "Find References", true);
